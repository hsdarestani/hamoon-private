...
function patchLifecycleSource(originalSource) {
  ...
  if (!source.includes('HETZNER_PROVISIONING_IP_REJECTED_ROLLED_BACK') ||
      ...
      !source.includes('const quality = await checkQuality(ip);') ||
      !source.includes("reason: 'network_not_ready'")) {
